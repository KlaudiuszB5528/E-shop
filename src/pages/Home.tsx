...
const Home: React.FC = () => {
  return (
    <div className="flex h-screen w-screen flex-col lg:flex-row">
      <div className="basis-1/2 lg:order-2 lg:basis-2/3">
        <Slider images={images} />
      </div>
      <div className="flex basis-1/2 flex-col items-center justify-start gap-12 px-6 pt-20 lg:order-1 lg:basis-1/3 ">
        ...
        <button className="group relative rounded-md border-2 border-black py-4 px-6 text-2xl shadow-md transition-all duration-300 before:absolute before:top-0 before:left-0 before:h-0 before:w-0 before:rounded-sm before:bg-black before:transition-all before:duration-300 hover:-translate-y-1 hover:shadow-xl before:hover:h-full before:hover:w-full active:-translate-y-0 active:shadow-sm">
          <Link
            to="/products"
